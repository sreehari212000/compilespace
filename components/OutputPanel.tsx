...
const OutputPanel = () => {
  ...
  return (
    <div className='relative bg-[#1f1f24] rounded-xl p-4 ring-1 ring-gray-800/50'>
      ...
      <div className='relative'>
            <div className='relative bg-[#1e1e2e]/50 backdrop-blur-sm border border-[#313244] 
                rounded-xl p-4 h-[600px] overflow-auto font-mono text-sm'>
                  ...
                  </div>) : (<div className="h-full flex flex-col items-center justify-center text-gray-500">
